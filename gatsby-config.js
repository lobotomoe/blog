module.exports = {
  siteMetadata: {
    ...
    author: {
      ...
      summary: `Software engineer. Lead in cryptostartup.`,
    },
    description: `Share my thoughts`,
    siteUrl: `https://blog.loboto.moe/`,
    social: {
      twitter: '@lobotomoe',
    },
  },
  ...
  plugins: [
        ...
        feeds: [
          {
            ...
            `,
            output: "/rss.xml",
            title: "Aleksandr Kraiz's Blog RSS Feed",
          },
        ],
      },
    },
    {
      ...
      options: {
        name: `Aleksandr Kraiz's Blog`,
        short_name: `Just blog`,
        start_url: `/`,
